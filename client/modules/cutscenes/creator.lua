-- Story Mode Quality Cutscene Creator - Complete Version
...
CreateThread(function()
    ...
    local stored = LoadResourceFile(resourceName, LL.Cutscenes.SavedCutscenesFile)
...
function ShowContextMenu()
    ...
    if selectedType == 'actor' then
        table.insert(options, {label = "Edit Position", action = function() OpenVec4Editor(selectedType, selectedIndex) end})
...
-- NUI Callbacks (folytatás következik...)